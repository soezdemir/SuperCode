...
public class Spielbrett
{
    ...
    //deprecated siehe FarbVektor.java
    //public static final int SCHWARZERHOEHEN = 2;
    //public static final int WEISSERHOEHEN = 3;

    /*private FarbVektor rot = new FarbVektor(Spielfigur.ROT);
    private FarbVektor blau = new FarbVektor(Spielfigur.BLAU);
    private FarbVektor gruen = new FarbVektor(Spielfigur.GRUEN);
    private FarbVektor gelb = new FarbVektor(Spielfigur.GELB);
    private FarbVektor lila = new FarbVektor(Spielfigur.LILA);
    private FarbVektor orange = new FarbVektor(Spielfigur.ORANGE);
    private FarbVektor pink = new FarbVektor(Spielfigur.PINK);
    private FarbVektor hellgruen = new FarbVektor(Spielfigur.HELLGRUEN);*/
